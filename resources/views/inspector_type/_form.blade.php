...
<div class="form-group @if ($errors->has('inspection_subtypes_id')) has-error @endif">
    ...
    {!!Form::select('inspection_subtypes_id', $inspectionSubtype, isset($inspector_type) ? $inspector_type->inspection_subtypes_id : null, ['class' => 'input-body', 'placeholder' => trans('words.ChooseOption')])!!}

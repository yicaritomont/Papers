<div class="form-group @if ($errors->has('company_id')) has-error @endif" id="motrarcompanies" style="display:{!! $companyselect !!};">
    ...
    {!! Form::select('company_id',$companies, isset($user) ? $user->companies->pluck('id')->toArray() : null, ['class' => 'input-body chosen-select form-control','id' => 'company_formato',$disabled,'placeholder' => trans('words.ChooseOption')]) !!}
...
<div class="form-group @if ($errors->has('client_id')) has-error @endif">
    ...
    <div  id="contenedor_client">
      {!! Form::select('client_id',['' => trans('words.ChooseOption')], null, ['class' => 'input-body chosen-select form-control', 'id' => 'cliente_formato',$disabled]) !!}
...
<div class="form-group @if ($errors->has('preformat_id')) has-error @endif" id="contenedor_preformat">
    ...
    {!! Form::select('preformat_id',$preformats, null, ['class' => 'input-body chosen-select form-control','id' => 'format_preformato',$disabled,'placeholder' => trans('words.ChooseOption')]) !!}

...
@section('content')
    <div class="row">
        <div class="col-md-5">
            <h3 class="modal-title">{{ $result }} {{ trans_choice('words.InspectionType',$result) }}</h3>
        </div>
...
@section('scripts')
    <script>  
        ...
        $(document).ready(function() {
            ...
            @can('edit_inspectiontypes','delete_inspectiontypes')
                dataTableObject.ajax = "{{ route('datatable', ['model' => 'InspectionType', 'entity' => 'inspectiontypes', 'identificador' => 'id']) }}";
            ...
            @else
                dataTableObject.ajax = "{{ route('datatable', ['model' => 'InspectionType', 'entity' => 'inspectiontypes']) }}";
                dataTableObject.columns = [
                    {data: 'id'},
                    {data: 'name'},
                    {data: 'created_at'},
